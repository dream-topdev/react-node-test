        ...
        <div className="mb-6">
          <div className="flex bg-gray-200 rounded-lg p-1">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${selectedRole === "user"
            ...
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${selectedRole === "admin"
                ? "bg-white text-blue-600 shadow-sm"
                : "text-gray-600 hover:text-gray-800"
                }`}
            >
